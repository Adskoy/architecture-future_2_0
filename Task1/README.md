...
* Добавляем кафку для ивентинга новых сервисов;
* Сохраняем Camel для доступа к легаси и интегрируем его с кафкой - так не придется переписывать финтех/ии сервисы;
* Airflow забирает батчами события из кафки и пишет в таблицы Iceberg;
* Для каталогизации используется Nessie;
* Для аналитики создаются отдельные витрины;
